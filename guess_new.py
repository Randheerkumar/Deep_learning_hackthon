...
def main(model_dir,class_type,image_path,FLAGS):  # pylint: disable=unused-argument
        ...
        with tf.device(FLAGS.device_id):
            ...
            if not FLAGS.single_look:
                ...
                for image_file in image_files:
                    ...
                    my_dict[image_file]=temp
                    ret.append(my_dict.copy())
